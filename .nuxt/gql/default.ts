...
/** Allowed Content Types of the PaHossz taxonomy. */
export enum ContentTypesOfPaHosszEnum {
  /** The Type of Content object */
  PRODUCT = 'PRODUCT'
}
...
/** Allowed Content Types of the PaSzin taxonomy. */
export enum ContentTypesOfPaSzinEnum {
  /** The Type of Content object */
  PRODUCT = 'PRODUCT'
}
...
/** Input for the createPaHossz mutation. */
export type CreatePaHosszInput = {
  /** The slug that the pa_hossz will be an alias of */
  aliasOf?: InputMaybe<Scalars['String']['input']>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** The description of the pa_hossz object */
  description?: InputMaybe<Scalars['String']['input']>;
  /** The name of the pa_hossz object to mutate */
  name: Scalars['String']['input'];
  /** If this argument exists then the slug will be checked to see if it is not an existing valid term. If that check succeeds (it is not a valid term), then it is added and the term id is given. If it fails, then a check is made to whether the taxonomy is hierarchical and the parent argument is not empty. If the second check succeeds, the term will be inserted and the term id will be given. If the slug argument is empty, then it will be calculated from the term name. */
  slug?: InputMaybe<Scalars['String']['input']>;
};
...
/** Input for the createPaSzin mutation. */
export type CreatePaSzinInput = {
  /** The slug that the pa_szin will be an alias of */
  aliasOf?: InputMaybe<Scalars['String']['input']>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** The description of the pa_szin object */
  description?: InputMaybe<Scalars['String']['input']>;
  /** The name of the pa_szin object to mutate */
  name: Scalars['String']['input'];
  /** If this argument exists then the slug will be checked to see if it is not an existing valid term. If that check succeeds (it is not a valid term), then it is added and the term id is given. If it fails, then a check is made to whether the taxonomy is hierarchical and the parent argument is not empty. If the second check succeeds, the term will be inserted and the term id will be given. If the slug argument is empty, then it will be calculated from the term name. */
  slug?: InputMaybe<Scalars['String']['input']>;
};
...
export type CreateProductInput = {
  /** Set connections between the Product and allPaHossz */
  allPaHossz?: InputMaybe<ProductAllPaHosszInput>;
  /** Set connections between the Product and allPaMeret */
  allPaMeret?: InputMaybe<ProductAllPaMeretInput>;
  /** Set connections between the Product and allPaSzin */
  allPaSzin?: InputMaybe<ProductAllPaSzinInput>;
...
/** Input for the deletePaHossz mutation. */
export type DeletePaHosszInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** The ID of the paHossz to delete */
  id: Scalars['ID']['input'];
};
...
/** Input for the deletePaSzin mutation. */
export type DeletePaSzinInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** The ID of the paSzin to delete */
  id: Scalars['ID']['input'];
};
...
/** Arguments for filtering the PaHosszToContentNodeConnection connection */
export type PaHosszToContentNodeConnectionWhereArgs = {
  /** The Types of content to filter */
  contentTypes?: InputMaybe<Array<InputMaybe<ContentTypesOfPaHosszEnum>>>;
  /** Filter the connection based on dates */
  dateQuery?: InputMaybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword?: InputMaybe<Scalars['Boolean']['input']>;
...
/** Arguments for filtering the PaHosszToProductConnection connection */
export type PaHosszToProductConnectionWhereArgs = {
  /** Limit result set to products with a specific global product attribute */
  attribute?: InputMaybe<Scalars['String']['input']>;
  /** Limit result set to products with a specific global product attribute term ID (required an assigned attribute). */
  attributeTerm?: InputMaybe<Scalars['String']['input']>;
...
/** Arguments for filtering the PaHosszToProductVariationConnection connection */
export type PaHosszToProductVariationConnectionWhereArgs = {
  /** Limit result set to products with a specific global product attribute */
  attribute?: InputMaybe<Scalars['String']['input']>;
  /** Limit result set to products with a specific global product attribute term ID (required an assigned attribute). */
  attributeTerm?: InputMaybe<Scalars['String']['input']>;
...
/** Arguments for filtering the PaSzinToContentNodeConnection connection */
export type PaSzinToContentNodeConnectionWhereArgs = {
  /** The Types of content to filter */
  contentTypes?: InputMaybe<Array<InputMaybe<ContentTypesOfPaSzinEnum>>>;
  /** Filter the connection based on dates */
  dateQuery?: InputMaybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword?: InputMaybe<Scalars['Boolean']['input']>;
...
/** Arguments for filtering the PaSzinToProductConnection connection */
export type PaSzinToProductConnectionWhereArgs = {
  /** Limit result set to products with a specific global product attribute */
  attribute?: InputMaybe<Scalars['String']['input']>;
  /** Limit result set to products with a specific global product attribute term ID (required an assigned attribute). */
  attributeTerm?: InputMaybe<Scalars['String']['input']>;
...
/** Arguments for filtering the PaSzinToProductVariationConnection connection */
export type PaSzinToProductVariationConnectionWhereArgs = {
  /** Limit result set to products with a specific global product attribute */
  attribute?: InputMaybe<Scalars['String']['input']>;
  /** Limit result set to products with a specific global product attribute term ID (required an assigned attribute). */
  attributeTerm?: InputMaybe<Scalars['String']['input']>;
...
/** Set relationships between the Product to allPaHossz */
export type ProductAllPaHosszInput = {
  /** If true, this will append the paHossz to existing related allPaHossz. If false, this will replace existing relationships. Default true. */
  append?: InputMaybe<Scalars['Boolean']['input']>;
  /** The input list of items to set. */
  nodes?: InputMaybe<Array<InputMaybe<ProductAllPaHosszNodeInput>>>;
};

/** List of allPaHossz to connect the Product to. If an ID is set, it will be used to create the connection. If not, it will look for a slug. If neither are valid existing terms, and the site is configured to allow terms to be created during post mutations, a term will be created using the Name if it exists in the input, then fallback to the slug if it exists. */
export type ProductAllPaHosszNodeInput = {
  /** The description of the paHossz. This field is used to set a description of the paHossz if a new one is created during the mutation. */
  description?: InputMaybe<Scalars['String']['input']>;
  /** The ID of the paHossz. If present, this will be used to connect to the Product. If no existing paHossz exists with this ID, no connection will be made. */
  id?: InputMaybe<Scalars['ID']['input']>;
  /** The name of the paHossz. This field is used to create a new term, if term creation is enabled in nested mutations, and if one does not already exist with the provided slug or ID or if a slug or ID is not provided. If no name is included and a term is created, the creation will fallback to the slug field. */
  name?: InputMaybe<Scalars['String']['input']>;
  /** The slug of the paHossz. If no ID is present, this field will be used to make a connection. If no existing term exists with this slug, this field will be used as a fallback to the Name field when creating a new term to connect to, if term creation is enabled as a nested mutation. */
  slug?: InputMaybe<Scalars['String']['input']>;
};
...
/** Set relationships between the Product to allPaSzin */
export type ProductAllPaSzinInput = {
  /** If true, this will append the paSzin to existing related allPaSzin. If false, this will replace existing relationships. Default true. */
  append?: InputMaybe<Scalars['Boolean']['input']>;
  /** The input list of items to set. */
  nodes?: InputMaybe<Array<InputMaybe<ProductAllPaSzinNodeInput>>>;
};

/** List of allPaSzin to connect the Product to. If an ID is set, it will be used to create the connection. If not, it will look for a slug. If neither are valid existing terms, and the site is configured to allow terms to be created during post mutations, a term will be created using the Name if it exists in the input, then fallback to the slug if it exists. */
export type ProductAllPaSzinNodeInput = {
  /** The description of the paSzin. This field is used to set a description of the paSzin if a new one is created during the mutation. */
  description?: InputMaybe<Scalars['String']['input']>;
  /** The ID of the paSzin. If present, this will be used to connect to the Product. If no existing paSzin exists with this ID, no connection will be made. */
  id?: InputMaybe<Scalars['ID']['input']>;
  /** The name of the paSzin. This field is used to create a new term, if term creation is enabled in nested mutations, and if one does not already exist with the provided slug or ID or if a slug or ID is not provided. If no name is included and a term is created, the creation will fallback to the slug field. */
  name?: InputMaybe<Scalars['String']['input']>;
  /** The slug of the paSzin. If no ID is present, this field will be used to make a connection. If no existing term exists with this slug, this field will be used as a fallback to the Name field when creating a new term to connect to, if term creation is enabled as a nested mutation. */
  slug?: InputMaybe<Scalars['String']['input']>;
};
...
/** Arguments for filtering the ProductToPaHosszConnection connection */
export type ProductToPaHosszConnectionWhereArgs = {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars['String']['input']>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars['Int']['input']>;
...
/** Arguments for filtering the ProductToPaSzinConnection connection */
export type ProductToPaSzinConnectionWhereArgs = {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars['String']['input']>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars['Int']['input']>;
...
/** Arguments for filtering the RootQueryToPaHosszConnection connection */
export type RootQueryToPaHosszConnectionWhereArgs = {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars['String']['input']>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars['Int']['input']>;
...
/** Arguments for filtering the RootQueryToPaSzinConnection connection */
export type RootQueryToPaSzinConnectionWhereArgs = {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars['String']['input']>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars['Int']['input']>;
...
export enum TaxonomyEnum {
  ...
  CATEGORY = 'CATEGORY',
  /** Taxonomy enum pa_hossz */
  PAHOSSZ = 'PAHOSSZ',
  /** Taxonomy enum pa_meret */
  PAMERET = 'PAMERET',
  /** Taxonomy enum pa_szin */
  PASZIN = 'PASZIN',
...
/** Input for the updatePaHossz mutation. */
export type UpdatePaHosszInput = {
  /** The slug that the pa_hossz will be an alias of */
  aliasOf?: InputMaybe<Scalars['String']['input']>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** The description of the pa_hossz object */
  description?: InputMaybe<Scalars['String']['input']>;
  /** The ID of the paHossz object to update */
  id: Scalars['ID']['input'];
  /** The name of the pa_hossz object to mutate */
  name?: InputMaybe<Scalars['String']['input']>;
  /** If this argument exists then the slug will be checked to see if it is not an existing valid term. If that check succeeds (it is not a valid term), then it is added and the term id is given. If it fails, then a check is made to whether the taxonomy is hierarchical and the parent argument is not empty. If the second check succeeds, the term will be inserted and the term id will be given. If the slug argument is empty, then it will be calculated from the term name. */
...
/** Input for the updatePaSzin mutation. */
export type UpdatePaSzinInput = {
  /** The slug that the pa_szin will be an alias of */
  aliasOf?: InputMaybe<Scalars['String']['input']>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** The description of the pa_szin object */
  description?: InputMaybe<Scalars['String']['input']>;
  /** The ID of the paSzin object to update */
  id: Scalars['ID']['input'];
  /** The name of the pa_szin object to mutate */
  name?: InputMaybe<Scalars['String']['input']>;
  /** If this argument exists then the slug will be checked to see if it is not an existing valid term. If that check succeeds (it is not a valid term), then it is added and the term id is given. If it fails, then a check is made to whether the taxonomy is hierarchical and the parent argument is not empty. If the second check succeeds, the term will be inserted and the term id will be given. If the slug argument is empty, then it will be calculated from the term name. */
